...
class ReadDTCByStatus(BaseService):
    _sid = 0x18
    ...
    @classmethod
    def make_request(cls, status_mask=None, severity_mask=None, dtc=None, snapshot_record_number=None, extended_data_record_number=None):
        """
        ...
        print("UUUUU %s" % [status_mask])
        req.data = struct.pack('>BBB', *status_mask) # 00 FF 00
    ...
    @classmethod
    def interpret_response(cls, response, status_mask,  extended_data_size=None, tolerate_zero_padding=True, ignore_all_zero_dtc=True, dtc_snapshot_did_size=2, didconfig=None):
        """
    ...
    class ResponseData(BaseResponseData):
        ...
        """            
        def __init__(self):
            super().__init__(ReadDTCByStatus)
...
class ReadDTCByStatus_recharge(ReadDTCByStatus, BaseService):
    _sid = 0x19
